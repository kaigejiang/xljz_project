...
public class FrontUploadImgController {
    /*
     * 图片命名格式
     */
    private static final String DEFAULT_SUB_FOLDER_FORMAT_AUTO = "yyyyMMddHHmmss";

    protected Logger logger = Logger.getLogger(FrontUploadImgController.class);

    /*
     * 上传图片文件夹
     */
    private static final String UPLOAD_PATH = "/upload/wordimg/";
